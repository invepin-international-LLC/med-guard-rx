    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-lg mx-auto px-6 pt-16 pb-12 text-center">
          <div className="w-24 h-24 bg-primary rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg rotate-3 hover:rotate-0 transition-transform">
              ...
              {TUTORIAL_SLIDES.map((_, i) => (
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all ${
                    i === currentSlide ? 'bg-accent w-8' : 'bg-border'
                  }`}
                />
              ))}
            </div>
